...
4. `npx vsce package` (produces `konashevich-pdf-viewer-1.0.1.vsix`)
5. Install the VSIX either via `code --install-extension konashevich-pdf-viewer-1.0.1.vsix` or the VS Code command palette (`Extensions: Install from VSIX...`).
